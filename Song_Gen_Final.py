...
# Function for grabbing random songs from spotify
...
# Function for giving more songs based on like artists
...
# Pulling random songs from the range above and recording user input
...
#  Give more songs based on user input
if liked_artists:
